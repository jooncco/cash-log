    ...
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex gap-4">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 rounded-lg border-2 transition-colors ${
                  theme === 'light'
                    ? 'border-blue-600 bg-blue-50 dark:bg-blue-900 text-gray-900 dark:text-gray-100'
                    : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 text-gray-900 dark:text-gray-100'
                }`}
          ...
          <div>
            <label htmlFor="language-select" className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">
              {t('language')}
            </label>
            <select
              id="language-select"
              ...
              className="pl-4 pr-10 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 appearance-none bg-no-repeat bg-right"
              style={{
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{t('categories')}</h2>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{t('tags')}</h2>
          <Button 
            onClick={() => {
              setShowTagForm(true);
              setEditingTag(null);
        ...
        <div className="p-6">
          ...
          {tags.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400 text-center py-8">{t('noTags')}</p>
          ) : (
